...
これらの規約は、出し抜けに考えだされたものではない。これらの多くはスタイルガイドの編集者たちの経験に基づいており、多くのClojureコミュニティメンバーからのフィードバックと意見、そして、 https://www.clojurebook.com/["Clojure Programming"] や https://www.manning.com/books/the-joy-of-clojure-second-edition["The Joy of Clojure"] のような高い評価を受けている様々なリソースに基づいている。
