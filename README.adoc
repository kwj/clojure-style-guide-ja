...
ここに書かれていることは、どれも絶対的なものではありません。新たな慣習が確認されたり、Clojure自体の変更によって従来の慣習が時代遅れになったりすることに伴い、このスタイルガイドは時間とともに変化する。
...
遠慮なく改良案の https://github.com/bbatsov/clojure-style-guide/issues[Pull Requestを作って] ください。どうかよろしくお願いします。
