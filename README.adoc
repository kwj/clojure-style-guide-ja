...
これらの規約は、出し抜けに考えだされたものではない。これらの多くはスタイルガイドの編集者たちの経験に基づいており、多くのClojureコミュニティメンバーからのフィードバックと意見、そして、 https://www.clojurebook.com/["Clojure Programming"] や http://www.joyofclojure.com/["The Joy of Clojure"] のような高い評価を受けている様々なリソースに基づいている。
