...
BozhidarはClojureと優れたプログラミングスタイルに強い情熱を持っていて、https://clojure.org/community/contrib_howto#_coding_guidelines[Clojure library coding guidelines] の内容と、Java、Python、Rubyなどのプログラミング言語のスタイルガイドに書かれている典型的な内容のギャップを埋めることを目指していました。
現在も Bozhidar はこのガイドの主任編集者ですが、メンテナンス作業を手伝ってくれる編集者をさらに数名募集しています。
